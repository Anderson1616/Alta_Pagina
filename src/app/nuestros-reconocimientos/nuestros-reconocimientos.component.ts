...
@Component({
  selector: 'app-nuestros-reconocimientos',
  templateUrl: './nuestros-reconocimientos.component.html',
  styleUrls: ['./nuestros-reconocimientos.component.scss'],
  standalone: false,
})
export class NuestrosReconocimientosComponent implements OnInit {
